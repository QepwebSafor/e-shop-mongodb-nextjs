...
const HomeBanner = () => {
  return (
    <div className='relative bg-gradient-to-r from-sky-500  to-sky-700 mb-8 '>
        <div className='md:flex-row items-center justify-evenly mx-auto px-8 py-12 flex flex-col'>
          ...
          <div className='w-1/3 relative aspect-video'>
            <Image src="/banner-image.png" fill sizes='256' alt="Banner Image" className='object-contain'/>
          </div>
        </div>
      </div>
